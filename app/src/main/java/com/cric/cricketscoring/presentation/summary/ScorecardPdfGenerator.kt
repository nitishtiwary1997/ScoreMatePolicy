...
object ScorecardPdfGenerator {
    ...
    // ── One innings ────────────────────────────────────────────────────
    private fun drawInnings(pc: PageContext, score: com.cric.cricketscoring.domain.model.InningsScore) {
    ...
    // ── Green team banner ──────────────────────────────────────────────
    private fun drawTeamBanner(pc: PageContext, score: com.cric.cricketscoring.domain.model.InningsScore) {
        pc.need(28f)
        val h = 26f
    ...
    // ── Batting table ──────────────────────────────────────────────────
    private fun drawBatting(pc: PageContext, score: com.cric.cricketscoring.domain.model.InningsScore) {
        // Column header row
        pc.need(18f)
        val hh = 18f
    ...
    // ── Bowling table ──────────────────────────────────────────────────
    private fun drawBowling(pc: PageContext, score: com.cric.cricketscoring.domain.model.InningsScore) {
    ...
    private fun drawFow(pc: PageContext, score: com.cric.cricketscoring.domain.model.InningsScore) {
        pc.need(18f)
        val hh = 18f
        pc.fillRect(M, pc.y, CW, hh, GREEN_DARK)
